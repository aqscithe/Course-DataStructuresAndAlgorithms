...
protected:
  ...
  auto placeNode(std::shared_ptr<BinaryNode<ItemType>> subTreePtr,
   ...
   void displayTreeHelper(std::shared_ptr<BinaryNode<ItemType>> treePtr, int depth, bool isLeft) const;
...
public:
   ...
   void displayTree() const;  // New method to print the tree structure
